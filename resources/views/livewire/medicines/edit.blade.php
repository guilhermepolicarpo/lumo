<div>
    {{-- HEADER --}}
    <x-header title="Editar fluídico" size="text-2xl" progress-indicator />
    ...
    <x-card class="max-w-xl">
        <x-form wire:submit="save">
            ...
            <x-textarea label="Descrição" wire:model="description" placeholder="Digite uma descrição para este fluídico..." rows="5" />
